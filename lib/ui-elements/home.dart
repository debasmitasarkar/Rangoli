...
const Color _kAppBackgroundColor = Color(0xFF152175);
...
class AnimationDemoHome extends StatefulWidget {
  AnimationDemoHome({Key key, List<Section> allSections});
...
class _AnimationDemoHomeState extends State<AnimationDemoHome> {
  ...
  Widget _toggleBackButton(appBarMidScrollOffset, statusBarHeight) {
    return _showBackButton == true
        ? Positioned(
            top: statusBarHeight,
            left: 0.0,
            child: IconTheme(
    ...
    return SizedBox.expand(
      child: Stack(
        children: <Widget>[
          ...
          _toggleBackButton(appBarMidScrollOffset, statusBarHeight)
        ],
      ),
    );
  }
